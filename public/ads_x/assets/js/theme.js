...
function initMap() {
    ...
    var image = "{{asset('emvor/assets/img/icons/map.png')}}";
...
// fonction price ranger deplacer ver sohp.blade.php
// // price ranger fonction
$(function () {
...
//     console.log(val);
//     load_data($("#minimum_range").val(),$("#maximum_range").val());
// })
/*------------------- Price Range Slider  -------------------*/
