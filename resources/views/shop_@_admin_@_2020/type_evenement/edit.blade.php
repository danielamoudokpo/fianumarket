...
@section('titre')
<h3>MISE A JOUR DU TYPE D'EVENEMENT'.</h3>
<p>Mise a jour type d'evenement</p>
@endsection
    ...
    <div class="panel-body">
        <div class="fixed-fluid">
            <div class="fluid">
                ...
                <!--===================================================-->
                <!--Input form-->
                <form  class="form-horizontal" action="{{route('admin.type_evenement.update', ['id' => $infos->id])}}" enctype="multipart/form-data" method="POST">
                    @csrf
                    @method('POST')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-11">
                            <input type="text" id="inputSubject" name="libelle" class="form-control  @error('libelle') is-invalid @enderror" value="{{$infos->libelle}}">
                        </div>
                    </div>
