...
<header class="content__title">
    ...
    <div class="actions">
        ...
        <a href="{{route('admin.categorie.edit', ['id' => $categorie->id])}}" class="actions__item zwicon-refresh-double"></a>
...
<div class="card">
    <div class="card-body">
        ...
        <input type="text" class="form-control  @error('designation') is-invalid @enderror" value="{{ old($categorie->designation)}}{{$categorie->designation}}" name="designation">
            @error('designation')
